...
static unsigned int gpioLED = 2;       ///< hard coding the LED gpio for this example to P9_23 (GPIO49)
// static unsigned int gpioButton = 14;   ///< hard coding the button gpio for this example to P9_27 (GPIO115)
